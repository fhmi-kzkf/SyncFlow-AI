...
export const formInputSchema = z.object({
  ...
  targetUser: z.string().min(2, "Target user required").max(500, "Target user is too long"),
  features: z.array(z.string().max(500)).max(20, "Too many features (max 20)"),
  stack: z.string().max(1000, "Stack description too long"),
